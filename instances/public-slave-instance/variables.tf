...
variable "public_tg_arn--http" {
  type        = "string"
  description = "The public target group arn these instances should be attached to."
}

variable "public_tg_arn--https" {
  type        = "list"
  description = "The public target group arn these instances should be attached to."
...
variable "private_tg_arn--http" {
  type        = "string"
  description = "The private target group arn these instances should be attached to."
}

variable "private_tg_arn--https" {
  type        = "list"
  description = "The private target group arn these instances should be attached to."
